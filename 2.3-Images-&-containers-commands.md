...
3. Copying Files Between Host and Containers
3.1 Copying Files from Host to Container
...
3.2 Copying Files from Container to Host
...
4.1 Understanding Attached and Detached Modes
...
4.2 Key Points on Container Lifecycle
